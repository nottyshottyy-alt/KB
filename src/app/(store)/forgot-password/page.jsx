                ...
                <div className="bg-zinc-900/80 backdrop-blur-2xl border border-white/5 p-8 md:p-10 rounded-[2.5rem] shadow-2xl">
                    {sent ? (
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center space-y-6">
                            ...
                            <Link href="/login" className="inline-flex items-center gap-2 text-[10px] font-black text-slate-500 uppercase tracking-widest hover:text-primary-500 transition-colors">
                        ...
                        <form onSubmit={submitHandler} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest px-2 flex items-center gap-2">
                                    <Mail className="w-3.5 h-3.5" /> Your Gmail Address
                                </label>
                                <input
                                    type="email"
                                    required
