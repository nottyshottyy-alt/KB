        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
                ...
                {cartItems.length === 0 ? (
                    ...
                    >
                        ...
                        <Link to="/products" className="relative z-10 inline-flex items-center gap-3 sm:gap-4 py-3.5 sm:py-5 px-7 sm:px-10 bg-primary-500 text-zinc-950 font-black uppercase tracking-[0.3em] rounded-xl sm:rounded-2xl hover:bg-white transition-all shadow-2xl text-xs">
                                ...
                                {cartItems.map((item) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0 space-y-0.5 sm:space-y-1 text-left">
                                            ...
                                            <Link to={`/product/${item.product}`} className="block text-sm sm:text-lg font-black text-white italic uppercase tracking-tighter hover:text-primary-500 transition-colors leading-tight truncate pr-2">
                                                {item.name}
                                            </Link>
                                        ...
                                        <div className="flex flex-col items-end gap-2 flex-shrink-0">
                                            <div className="flex items-center gap-2 sm:gap-4 bg-zinc-950 p-1 sm:p-1.5 rounded-xl border border-white/5">
                                                ...
                                                {/* Trash Icon integrated for mobile */}
                                    ...
                                    {appliedCoupon ? (
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className="px-4 sm:px-6 bg-zinc-950 border border-white/5 text-slate-500 font-black rounded-xl sm:rounded-2xl hover:text-white hover:bg-zinc-800 transition disabled:opacity-50 flex items-center justify-center gap-2 text-[10px] tracking-widest"
                                            >
                                ...
                                <div className="space-y-3 sm:space-y-4">
                                    ...
                                    {appliedCoupon && (
                                        <div className="flex justify-between text-primary-500">
                                            <span className="text-[10px] font-black uppercase tracking-widest italic">Coupon Discount</span>
