...
const HomePage = () => {
    ...
    useEffect(() => {
        document.title = "COMPUTERS | High-Performance Hardware";
                ...
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 w-full relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-12 lg:gap-20 items-center">
                        ...
                        <div className="text-center lg:text-left space-y-8">
                            ...
                            >
                                <Link to="/products" className="group relative px-8 sm:px-10 py-4 sm:py-5 bg-primary-500 text-zinc-950 font-black uppercase tracking-widest text-[10px] sm:text-xs rounded-full hover:bg-white transition-all overflow-hidden shadow-[0_0_30px_rgba(68,214,44,0.3)]">
                                    <span className="relative z-10 flex items-center gap-2 sm:gap-3">
                                        Shop The Collection <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                                    </span>
                                </Link>
                                <Link to="/products?category=monitors" className="px-8 sm:px-10 py-4 sm:py-5 bg-white/5 text-white font-black uppercase tracking-widest text-[10px] sm:text-xs rounded-full border border-white/10 hover:bg-white/10 transition-all backdrop-blur-md">
                                    Explore Monitors
                                </Link>
                            </motion.div>
                        </div>
            ...
            <section className="py-24 bg-zinc-900/50 border-y border-white/5">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        ...
                        <Link to="/products" className="group flex items-center gap-3 text-xs font-black uppercase tracking-widest text-primary-500 hover:text-white transition-colors">
